        ...
        {isFilled ? (
          <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M14.9999 18C14.9999 17.4477 15.4476 17 15.9999 17H21.9999C22.5522 17 22.9999 17.4477 22.9999 18C22.9999 18.5523 22.5522 19 21.9999 19H15.9999C15.4476 19 14.9999 18.5523 14.9999 18Z"
              fill={color}
            />
            <path
              fillRule="evenodd"
