      ...
      <AccessibleIcon.Root label={label}>
        {isFilled ? (
          <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              d="M19.707 14.2929C19.3165 13.9024 18.6833 13.9024 18.2928 14.2929C17.9022 14.6834 17.9022 15.3166 18.2928 15.7071L19.5857 17H15.9999C15.4476 17 14.9999 17.4477 14.9999 18C14.9999 18.5523 15.4476 19 15.9999 19H19.5857L18.2928 20.2929C17.9022 20.6834 17.9022 21.3166 18.2928 21.7071C18.6833 22.0976 19.3165 22.0976 19.707 21.7071L22.707 18.7071C22.8945 18.5196 22.9999 18.2652 22.9999 18C22.9999 17.7348 22.8945 17.4804 22.707 17.2929L19.707 14.2929Z"
              fill={color}
            />
            <path
              fillRule="evenodd"
