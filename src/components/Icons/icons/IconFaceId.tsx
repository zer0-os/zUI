        ...
        {isFilled ? (
          <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M7.5 7C8.05229 7 8.5 7.44772 8.5 8V9.5C8.5 10.0523 8.05229 10.5 7.5 10.5C6.94772 10.5 6.5 10.0523 6.5 9.5V8C6.5 7.44772 6.94772 7 7.5 7Z"
              fill={color}
            />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M16.5 7C17.0523 7 17.5 7.44772 17.5 8V9.5C17.5 10.0523 17.0523 10.5 16.5 10.5C15.9477 10.5 15.5 10.0523 15.5 9.5V8C15.5 7.44772 15.9477 7 16.5 7Z"
              fill={color}
            />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M12.5 7C13.0523 7 13.5 7.44772 13.5 8V11.1001C13.5 12.4524 12.3523 13.6001 11 13.6001C10.4477 13.6001 10 13.1524 10 12.6001C10 12.0478 10.4477 11.6001 11 11.6001C11.2477 11.6001 11.5 11.3478 11.5 11.1001V8C11.5 7.44772 11.9477 7 12.5 7Z"
              fill={color}
            />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M7.99309 14.4928C8.38361 14.1023 9.01678 14.1023 9.4073 14.4928C10.8168 15.9023 13.0836 15.9023 14.4931 14.4928C14.8836 14.1023 15.5168 14.1023 15.9073 14.4928C16.2978 14.8834 16.2978 15.5165 15.9073 15.9071C13.7168 18.0976 10.1836 18.0976 7.99309 15.9071C7.60257 15.5165 7.60257 14.8834 7.99309 14.4928Z"
              fill={color}
            />
          </svg>
        ) : (
