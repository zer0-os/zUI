      ...
      <AccessibleIcon.Root label={label}>
        {isFilled ? (
          <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              d="M19.707 15.7071C20.0975 15.3166 20.0975 14.6834 19.707 14.2929C19.3165 13.9024 18.6833 13.9024 18.2928 14.2929L15.2928 17.2929C15.1052 17.4804 14.9999 17.7348 14.9999 18C14.9999 18.2652 15.1052 18.5196 15.2928 18.7071L18.2928 21.7071C18.6833 22.0976 19.3165 22.0976 19.707 21.7071C20.0975 21.3166 20.0975 20.6834 19.707 20.2929L18.4141 19H21.9999C22.5522 19 22.9999 18.5523 22.9999 18C22.9999 17.4477 22.5522 17 21.9999 17H18.4141L19.707 15.7071Z"
              fill={color}
            />
            <path
              fillRule="evenodd"
