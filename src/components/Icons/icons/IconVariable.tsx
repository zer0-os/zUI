      ...
      <AccessibleIcon.Root label={label}>
        {isFilled ? (
          <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              d="M20.8025 2.55706C20.5577 2.06197 19.958 1.85903 19.4629 2.10378C18.9678 2.34854 18.7649 2.9483 19.0096 3.44339C20.2832 6.01968 21 8.92429 21 12.0002C21 15.0762 20.2832 17.9808 19.0096 20.5571C18.7649 21.0521 18.9678 21.6519 19.4629 21.8967C19.958 22.1414 20.5577 21.9385 20.8025 21.4434C22.2095 18.5974 23 15.3901 23 12.0002C23 8.61037 22.2094 5.40308 20.8025 2.55706Z"
              fill={color}
            />
            <path
              d="M4.99037 3.44339C5.23512 2.9483 5.03218 2.34854 4.53709 2.10378C4.042 1.85903 3.44224 2.06197 3.19749 2.55706C1.79052 5.40308 1 8.61037 1 12.0002C1 15.3901 1.79052 18.5974 3.19749 21.4434C3.44224 21.9385 4.042 22.1414 4.53709 21.8967C5.03218 21.6519 5.23512 21.0521 4.99037 20.5571C3.71674 17.9808 3 15.0762 3 12.0002C3 8.92429 3.71674 6.01968 4.99037 3.44339Z"
              fill={color}
            />
            <path
