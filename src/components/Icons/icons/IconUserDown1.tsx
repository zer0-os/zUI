      ...
      <AccessibleIcon.Root label={label}>
        {isFilled ? (
          <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              d="M19.9999 15C19.9999 14.4477 19.5522 14 18.9999 14C18.4476 14 17.9999 14.4477 17.9999 15V18.5858L16.707 17.2929C16.3165 16.9024 15.6833 16.9024 15.2928 17.2929C14.9022 17.6834 14.9022 18.3166 15.2928 18.7071L18.2928 21.7071C18.4803 21.8946 18.7347 22 18.9999 22C19.2651 22 19.5194 21.8946 19.707 21.7071L22.707 18.7071C23.0975 18.3166 23.0975 17.6834 22.707 17.2929C22.3165 16.9024 21.6833 16.9024 21.2928 17.2929L19.9999 18.5858V15Z"
              fill={color}
            />
            <path
              fillRule="evenodd"
