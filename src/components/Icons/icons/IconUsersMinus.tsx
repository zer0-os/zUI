        ...
        {isFilled ? (
          <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M15.0002 18C15.0002 17.4477 15.448 17 16.0002 17H22.0002C22.5525 17 23.0002 17.4477 23.0002 18C23.0002 18.5523 22.5525 19 22.0002 19H16.0002C15.448 19 15.0002 18.5523 15.0002 18Z"
              fill={color}
            />
            <path
              fillRule="evenodd"
